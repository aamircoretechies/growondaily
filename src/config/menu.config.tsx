...
export const MENU_SIDEBAR: TMenuConfig = [
  ...
  
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/bible-content/translations'
      },
      {
        title: 'Books & Chapters',
        path: '/bible-content/books-chapters'
      },
      {
  ...
  /* {
    ...
    children: [
      ...
      {
        title: 'Manage Plans',
        path: '/reading-plan/manage'
      },
      {
        title: 'Assign Plans',
        path: '/reading-plan/assign'
      },
      {
        title: 'Track Progress',
        path: '/reading-plan/progress'
      },
      {
        title: 'Content Management',
        path: '/reading-plan/content'
      },
      {
        title: 'Analytics',
        path: '/reading-plan/analytics'
      },
      {
        title: 'Notifications',
        path: '/reading-plan/notifications'
      }
    ]
  }, */
  ...
  
 {
    ...
    children: [
      ...
      {
        title: 'Subscribers ',
        path: '/monetization/subscription-plan'
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { title: 'User Detail', path: '/network/user-table/user-detail' },
