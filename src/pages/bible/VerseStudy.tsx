...
const VerseStudy = () => {
  ...
  const { books, selectedVerse, loading, fetchSingleVerse, } = useBible();
  ...
  const tabs = [
    { id: 'explanation', title: 'Explanation', icon: 'book-open' },
    { id: 'historical-context', title: 'Historical Context', icon: 'calendar' },
    { id: 'ground-text-analysis', title: 'Ground Text Analysis', icon: 'document' },
    { id: 'special-insights', title: 'Special Insights', icon: 'lightbulb' },
    { id: 'daily-life-application', title: 'Daily Life Application', icon: 'home' },
    { id: 'cross-reference', title: 'Cross Reference', icon: 'link' },
    { id: 'commentary-insights', title: 'Commentary Insights', icon: 'users' },
    { id: 'key-takeaways', title: 'Key Takeaways', icon: 'star' },
    { id: 'reflection-prompts', title: 'Reflection Prompts', icon: 'question' },
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white/40 dark:bg-gray-200 backdrop-blur-sm rounded-xl shadow-sm border border-gray-200 dark:border-gray-400">
        ...
        <div className="p-6">
          <p className="font-merriweather text-lg leading-relaxed text-primary mb-6">
            {loading
              ? 'Loading verse...'
              : selectedVerse?.text || 'Verse text not available'}
          </p>
          <div className="bg-white/60 dark:bg-gray-300 rounded-lg p-4 border border-gray-200 dark:border-gray-400">
            <div className="flex items-center gap-3 mb-2">
              <KeenIcon icon="calendar" className="text-gray-500 dark:text-gray-700 text-sm" />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-800">
                {currentDate} - {book.charAt(0).toUpperCase() + book.slice(1)} {chapter}:{verse}
              </span>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-800 font-merriweather">
              I feel like I'm learning to rest more instead of stressing...
