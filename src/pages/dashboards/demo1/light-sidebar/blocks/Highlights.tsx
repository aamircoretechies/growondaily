...
const Highlights = ({ limit }: IHighlightsProps) => {
  ...
  const items: IHighlightsItems = [
    { badgeColor: 'badge-success', lebel: 'Free Users' },
    { badgeColor: 'badge-warning', lebel: 'Subscribers' },
  ];
  ...
  return (
    <div className="card h-full">
      <div className="card-header">
        <h3 className="card-title">Overall Sales</h3>
      ...
      <div className="card-body flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
        ...
        <div className="flex items-center gap-1 mb-1.5">
          <div className="bg-success h-2 w-full max-w-[70%] rounded-sm"></div>
          <div className="bg-brand h-2 w-full max-w-[30%] rounded-sm"></div>
        </div>
