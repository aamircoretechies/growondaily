...
import { BiblePage, BibleContent } from '@/pages/bible';
import { AskPage } from '@/pages/ask';
import { ReflectionsPage } from '@/pages/reflections';
import { SavedJournalListPage } from '@/pages/reflections/SavedJournalListPage';
import { BookmarksPage } from '@/pages/reflections/BookmarksPage';
    ...
    <Routes>
      <Route element={<RequireAuth />}>
        <Route element={<Demo5Layout />}>
          ...
          <Route path="/bible/content" element={<BibleContent />} />
          ...
          <Route path="/reflections/journal" element={<SavedJournalListPage />} />
          <Route path="/reflections/bookmarks" element={<BookmarksPage />} />
